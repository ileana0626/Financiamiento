    ...
    <div>
        <table>
            <td>
                ...
                <strong>LISTADO DE CANDIDATURAS <br>{{$tipoEleccion}}</strong>
            </td>
        </table>
            ...
            <tbody>
                @foreach($Candidaturas as $key => $candidatura)
                    ...
                    @endif
                        ...
                        <td>{{ $candidatura->municipio_label }}</td>
