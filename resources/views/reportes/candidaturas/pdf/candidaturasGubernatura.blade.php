    ...
    <div class="container">
        ...
        <div>
            <table style="font-family: Verdana, Geneva, Tahoma, sans-serif; margin-top:20px; margin-left:-30px">
                <thead>
                    <tr style="padding:.3rem; color:#595959; font-size: 0.8rem; background-color: #f6f6f6; border-bottom: 1px solid #eee">
                        ...
                        <th style="padding:.3rem; border-left:1px solid #eee">CLAVE DE ELECTOR</th>
                        <th style="padding:.3rem; border-left:1px solid #eee">PERSONA CANDIDATA</th>
                        <th style="padding:.3rem; border-left:1px solid #eee">GENERO</th>
                ...
                <tbody style="">
                    @foreach($Candidaturas as $key => $candidatura)
                        @if (($key%2)==0) <tr style="background-color:#f7f7f7; font-size: 0.75rem;">
                        @else <tr style="background-color:#FFFFFF; font-size: 0.75rem;">
                        @endif
