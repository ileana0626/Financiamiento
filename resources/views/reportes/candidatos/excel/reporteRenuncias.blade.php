...
<head>
    ...
    <title>Reporte de Renuncias</title>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <strong>REPORTE DE RENUNCIAS</strong>
                </td>
            </tr>
        </table>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th><strong>NOMBRE DE LA PERSONA QUE RENUNCIA</strong></th>
                ...
                <tbody>
                    @foreach($Candidatos as $key => $candidato)
                        ...
                        @endif
                            ...
                            <td>{{ $candidato->fecha_captura}} {{ $candidato->tiempo_captura}} hrs.</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
