    ...
    <div class="container">
        <div class="cabecera">
            <h1>
                ...
                DE LA PLANILLA DE MIEMBROS DE AYUNTAMIENTO  <br>
            ...
            <span class="left-text">
                ...
                <strong>Distrito Electoral Uninominal (Numero y Cabecera): </strong>{{$Candidatos[0]->distrito_label}} <br>
                <strong>Municipal: </strong>{{$Candidatos[0]->municipio_label}} <br>
                <strong>Tipo de registro: </strong>Supletorio (Consejo General) <br>
