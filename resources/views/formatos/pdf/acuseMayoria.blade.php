    ...
    <div class="container">
        <div class="cabecera">
            <h1>
                ...
                PRINCIPIO DE MAYORIA RELATIVA SELECCIONADAS CONFORME A LOS <br>
            ...
            <span class="justify-text">
                Con fundamento en lo dispuesto por los artículos 42, fracción V y 206, fracción II del Código
                de Instituciones y Procesos Electorales del Estado Puebla (CIEEP), y en cumplimiento con
                las normas estatutarias del <strong>{{$Candidatos[0]->siglas_partido}}</strong> que represento,
                solicito el registro de la formula a Diputaciones por el principio de mayoría relativa del
                distrito electoral <strong>{{$Candidatos[0]->distrito_label}}</strong>, que contenderá en el
            ...
            <span class="left-text">A fin de dar cumplimiento a lo establecido por el artículo 208 del Código de la materia, se especifica a continuación los datos personales de las candidaturas postuladas:</span>
            
            <table class="detalles-candidato">
                @foreach ($Candidatos as $candidato)
                    @if ($candidato->idpuesto == 1)
                        <tr style="background-color: #a5904a;">
                            <td><table><tr><th>DATOS DE LA CANDIDATURA A DIPUTACIÓN &nbsp;&nbsp;&nbsp;&nbsp; PERSONA PROPIETARIA</th></tr></table></td>
                        </tr>
                        <tr><td><table><tr>
                ...
                @endforeach
                @foreach ($Candidatos as $candidato)
                    @if ($candidato->idpuesto == 2)
                        <tr style="background-color: #a5904a;"><td><table><tr>
                            <th>DATOS DE LA CANDIDATURA A DIPUTACIÓN &nbsp;&nbsp;&nbsp;&nbsp; PERSONA SUPLENTE</th>
                        </tr></table></td></tr>
                        <tr><td><table><tr>
                            <td style="width: 450px">
                                <small>PRIMER APELLIDO, SEGUNDO APELLIDO, NOMBRE(S): </small><br>
            ...
            <span class="justify-text">
                ...
                documentación adjunta para el registro de la fórmula para Diputación de mayoría
                relativa: --}}
            </span>
