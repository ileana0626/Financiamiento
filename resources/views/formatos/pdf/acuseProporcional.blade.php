...
<body>
    <div class="container">
        <div class="cabecera">
            <h1>
                SOLICITUD DE REGISTRO DE CANDIDATURAS A DIPUTACIONES POR EL <br>
                PRINCIPIO DE REPRESENTACIÓN PROPORCIONAL SELECCIONADAS <br>
                CONFORME A LOS ESTATUTOS DEL PARTIDO POLITICO.
            </h1>
            <br>
            ...
            <span class="justify-text">
                Con fundamento en lo dispuesto por los artículos 42 fracción V y 206 fracción IV del Código 
                de Instituciones y Procesos del Estado de Puebla (Codigo), y en cumplimiento con las
                normas estatutarias de  <strong>{{$Candidatos[0]->siglas_partido}}</strong> que represento,
                solicito el registro de candidaturas a Diputaciones por el principio de representación
                proporcional, que contenderán en el Proceso Electoral Estatal Ordinario Concurrente
                2023-2024, siendo los siguientes:
            </span>
            ...
            <table class="lista-general">
                ...
                @for ($diputaciones = 0; $diputaciones < 15; $diputaciones++)
                    <tr>
                        <td>
                            <table style="background-color: #a5904a;">
                                <td>{{$diputaciones + 1}}ª DIPUTACIÓN</td>
                                <td>
                                    <table>
                                        <tr>
                                            <td>PROPIETARIA</td>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        @foreach ($Candidatos as $candidato)
                                            @if (($candidato->idpuesto == $countPuesto+3))
                                ...
                                <tr>
                                    <td>
                                        @foreach ($Candidatos as $candidato)
                                            @if (($candidato->idpuesto == $countPuesto+4))
                                                {{$candidato->nombre_completo}}
                                            @endif
                                        @endforeach
                                    </td>
            ...
            <span class="justify-text">
                A fin de dar cumplimiento a lo establecido por el artículo 208 del Código de la materia, se
                especifica a continuación los datos personales de cada una de las candidaturas anteriormente
                citadas:
            </span>
            ...
            @for ($diputaciones = 0; $diputaciones < 15; $diputaciones++)
                <table class="detalles-candidato">
                    @foreach ($Candidatos as $candidato)
                        @if ($candidato->idpuesto == $countPuesto+3)
                            <tr style="background-color: #a5904a;">
                                <td><table><tr><th>{{$diputaciones+1}}ª DIPUTACIÓN &nbsp;&nbsp;&nbsp;&nbsp; PERSONA PROPIETARIA</th></tr></table></td>
                            </tr>
                            <tr><td><table><tr>
                        ...
                        @if ($candidato->idpuesto == $countPuesto+4)
                            <tr style="background-color: #a5904a;">
                                <td><table><tr><th>{{$diputaciones+1}}ª DIPUTACIÓN &nbsp;&nbsp;&nbsp;&nbsp; PERSONA SUPLENTE</th></tr></table></td>
                            </tr>
                            <tr><td><table><tr>
                                <td style="width: 450px">
                                    <small>PRIMER APELLIDO, SEGUNDO APELLIDO, NOMBRE(S): </small><br>
            ...
            <br>
            <span class="justify-text">
                Asimismo, manifiesto que las personas candidatas cuyo registro solicito, <strong>fueron seleccionadas
                de conformidad con los Estatutos del partido político o el convenio de la coalición</strong> que represento. <br><br>
                ...
                adjunta para el registro de Candidaturas de Diputaciones por el Principio de Representación
                Proporcional: --}}
            </span>
            ...
            <strong>
                <table class="firmas">
                    ...
                    <tr>
                        <td style="padding: 0 1rem"><span>
                            NOMBRE Y FIRMA AUTÓGRAFA DE LA PERSONA FACULTADA POR LOS ESTATUTOS <br>
                            DE CADA INSTITUTO POLÍTICO Y/O REPRESENTANTE ANTE EL CONSEJO GENERAL</span></td>
                    </tr>
                </table>
            </strong>
        </div>
