...
<body>
    <div class="container">
        <div class="cabecera">
            <h1>
                FORMATO DE CARTA PARA DAR CUMPLIMIENTO AL ARTÍCULO 208 INCISO F) DEL CIPEEP <br> (CANDIDATURAS A DIPUTACIONES)
            </h1>
            <br>
            ...
            <span class="justify-text">
                Con fundamento en lo establecido en los artículos 202 y 208 inciso f) del Código de
                Instituciones y Procesos Electorales del Estado de Puebla, así como el artículo 19 del
                Reglamento para la reelección a cargos de elección popular en el Estado de Puebla, y en
                virtud de que fui postulado(a) para el cargo de diputado(a) por el principio de
                <strong>{{$Candidato->tipo_eleccion_label}}</strong> del distrito <strong>{{$Candidato->distrito_label}}</strong> en el Estado de Puebla, por
                el (partido político, coalición, candidatura común o candidatura independiente)
                <strong>{{$Candidato->siglas_partido}}</strong> durante el Proceso Electoral Estatal Ordinario Concurrente 2023-2024.
            </span>
            <span class="left-text">
                En tal sentido, declaro que los periodos para los que he sido electo(a) en este cargo de manera consecutiva son:
            </span>
            <table class="figura-postulacion">
                ...
                <tr>
                    <td><strong>2do Periodo (1ra Reelección)</strong></td>
                    <td>________ a ________</td>
                    <td>_________________</td>
                    <td>_________________</td>
                </tr>
                <tr>
                    <td><strong>3er Periodo (2da Reelección)</strong></td>
                    <td>________ a ________</td>
                    <td>_________________</td>
                    <td>_________________</td>
                </tr>
                <tr>
                    <td><strong>4to Periodo (3ra Reelección)</strong></td>
                    <td>________ a ________</td>
                    <td>_________________</td>
                    <td>_________________</td>
                </tr>
