            ...
            <div class="container-fluid mb-md-3 pl-4 pl-md-3 pt-0">
                <div class="float-sm-right mr-5">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <router-link to="/indexSolicitudes"> <span>Solicitudes</span> </router-link>
                        </li>
            ...
            <div class="mx-3 mt-5 mt-md-4">
                ...
                <div class="card-info pb-4">
                    <div class="card-header d-flex">
                        <h3 class="card-title font-weight-bold">Editar solicitud</h3>
                    </div>
...
export default {
    ...
    async mounted() {
        ...
        await this.getDatosById();
        await this.getArchivoById();
        await this.getCopiasById();
        load.close();
    },
    methods: {
        handleTermino(){
        ...
        async getCopiasById() {
            const url = '/administracion/solicitud/getCopiasById';
            try {
                const response = await axios.get(url,{params: {
                    'idSolicitud': this.idSolicitud,
                }});
