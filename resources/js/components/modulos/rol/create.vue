            ...
            <div class="card-body">
                <div class="card mx-2 ">
                    <div class="card-header">
                        <h3 class="card-title">Formulario para registrar un rol</h3>
                            ...
                            <div class="row">
                                <div class="col-md-5 mt-2 mt-sm-0">
                                    <div class="card card-info">
                                        ...
                                        <div class="d-flex flex-wrap flex-lg-nowrap flex-row mb-4 w-50 mx-auto">
                                            <vs-button color="rgb(175, 137, 9)" class=" font-weight-bold mr-1" warn
                                                block @click.prevent="setRegistrarRolPermisos">

                                                Registrar

                                            </vs-button>
                                            <vs-button transparent dark block black class="font-weight-bold"
                                        ...
                                        <div class="row">
                                            <vs-button class="botonizq" flat warn
                                                ...
                                                v-loading.fullscreen.lock="fullscreenLoading">Registrar</vs-button>
                                            <vs-button class="botonder" block flat dark
