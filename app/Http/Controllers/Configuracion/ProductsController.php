...
class ProductsController extends Controller
{
    public function getListarProductos(Request $request)
    {
        ...
        $rpta = DB::select('call sp_Producto_getListarProductos ( ? , ? , ? , ? ) ', [ $nIdProducto , $cNombre , $cDescripcion , $nIdCategoria]);
    ...
    public function setRegistrarProducto(Request $request)
    {
        ...
        $rpta = DB::select('call sp_Producto_setRegistrarProducto ( ? , ? , ? , ? , ? , ?) ', [ $cNombre , $cDescripcion , $nStock , $fPrecio ,$nIdCategoria , $nIdAuthUser]);
    ...
    public function setEditarProducto(Request $request)
    {
        ...
        $rpta = DB::select('call sp_Producto_setEditarProducto ( ? , ? , ? , ? , ? , ? , ?  ) ', [ $nIdProducto , $cNombre , $cDescripcion , $nStock , $fPrecio ,$nIdCategoria , $nIdAuthUser ]);
