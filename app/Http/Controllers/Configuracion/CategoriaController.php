...
class CategoriaController extends Controller
{
    public function getListarCategorias(Request $request)
    {
        ...
        $rpta = DB::select('call sp_Categoria_getListarCategorias ( ? , ? , ? ) ', [ $nIdCategoria , $cNombre , $cDescripcion ]);
    ...
    public function setRegistrarCategoria(Request $request)
    {
        ...
        $cDescripcion = ($cDescripcion == NULL) ? ($cDescripcion = '') : $cDescripcion;
         ...
         DB::select('call sp_Categoria_setRegistrarCategoria( ? , ? , ? )', [ $cNombre , $cDescripcion , $nIdAuthUser]);
    ...
    public function setEditarCategoria(Request $request)
    {
        ...
        $rpta = DB::select('call sp_Categoria_setEditarCategoria ( ? , ? , ? , ? ) ', [ $nIdCategoria , $cNombre , $cDescripcion , $nIdAuthUser ]);
