...
```sql
-- Ejecutar ALTER TABLE si no se va a cargar las tablas de los partidos políticos y de cálculo
ALTER TABLE calculo_dppp ADD COLUMN finpriv_tope_presidencial DECIMAL(30,15) NULL COMMENT 'Tope de gastos para la elección presidencial inmediata anterior';
ALTER TABLE calculo_dppp ADD COLUMN finpriv_tope_gubernatura DECIMAL(30,15) NULL COMMENT 'Tope de gastos para la elección presidencial inmediata anterior';
...
```
###### Store Procedure que se agregan
* sp_FinPriv_Update_Partidos
* sp_FinPriv_Update_calculo

###### Store Procedure que se actualizan
* sp_get_calculo_completo
* sp_get_Partidos_Calculo_porId
